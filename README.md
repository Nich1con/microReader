...
- Автоматически переходит в один из двух режимов сети	
	1. **Режим AP** (точка доступа) 
    Режим AP запускается по умолчанию или при невозможности подключения к сети  	
	...
	2. **Режим STA** (подключение к сети)  
	Режим STA можно активировать из web-интерфейса, при включенном пункте "автоподключение" устройство
